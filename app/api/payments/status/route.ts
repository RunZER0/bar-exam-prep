...
export const GET = withAuth(async (_req: NextRequest, user) => {
  ...
  return NextResponse.json({
    ...
    canAccess: {
      ...
      tutor: info.canAccess('tutor'),
      community: info.canAccess('community'),
      legal_banter: info.canAccess('legal_banter'),
      history: info.canAccess('history'),
      dashboard: info.canAccess('dashboard'),
      reports: info.canAccess('reports'),
